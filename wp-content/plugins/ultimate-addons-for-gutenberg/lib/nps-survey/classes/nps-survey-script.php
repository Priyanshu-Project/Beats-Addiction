...
// Prevent multiple inclusions of this file AND the Class Redeclaration Error.
if ( ! class_exists( 'Nps_Survey' ) ) { // FIX: Added class_exists check.
     ...
     * Nps_Survey
     */
    class Nps_Survey { // FIX: Added the missing class declaration.
         ...
         * @since 1.0.0
         */
        private static $instance = null; // FIX: Removed stray 'public $some_property' and added missing semicolon.
    ...
    } // FIX: Added the closing brace for the class_exists check.
